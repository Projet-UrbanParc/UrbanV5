<?php
$target_dir = "../backEnd/LinksGroupes/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksGroupes/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksGroupes/img/header.png');
