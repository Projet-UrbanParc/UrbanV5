<?php
$target_dir = "../backEnd/LinksAccueil/img/";
...
// Check filesize
if($_FILES['file_upload']['size'] > 5000000000){
    die('Le fichier est trop lourd :(');
}


// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksAccueil/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksAccueil/img/header.png');
