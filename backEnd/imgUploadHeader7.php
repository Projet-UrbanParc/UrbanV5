<?php
$target_dir = "../backEnd/LinksTarifs/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksTarifs/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksTarifs/img/header.png');
