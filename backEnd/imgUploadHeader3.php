<?php
$target_dir = "../backEnd/LinksAnniversaire/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksAnniversaire/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksAnniversaire/img/header.png');
