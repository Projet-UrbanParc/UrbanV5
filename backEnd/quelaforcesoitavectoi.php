...
<html lang="fr">
    <head>
        ...
        <script src="./backJs/script.js"></script>
</head>
    <body>
        <form method="post" id="adminForm">
            ...
            <input value="Administrer"type="submit" onclick="txtInject()">
...
//************* ACCUEIL ******************************//
    if ($page == "LinksAccueil") {
       ...
       echo "<form method='post' action='txtUploadAccueil.php' id='accueilForm'>
        ...
        include 'LinksAccueil/Section4.html';
}
...
elseif ($page == "LinksBistrot") {
        ...
        echo "<form method='post' action='txtUploadBistrot1.php' id='bistrotForm'>
                ...
                <input type='submit' value='Valider' name='AccueilSubmit'>
                <input type='button' value='Actualiser' name='b1actu' id='b1actu'>
          </form>";
    
        include 'LinksBistrot/Section1.html';
    
        echo "<form method='post' action='txtUploadBistrot2.php' id='bistrotForm2'>
                <input type='text' name='titre1' id='titreAccueil1'>
                <textarea form='bistrotForm2' name='actualite'></textarea>
                <input type='submit' value='Valider' name='AccueilSubmit'>
          </form>";
                
        include 'LinksBistrot/Section2.html';
    
        echo "<form method='post' action='txtUploadBistrot3.php' id='bistrotForm3'>
                <input type='text' name='titre2' id='titreAccueil2'>
                <textarea form='bistrotForm3' name='actualite'></textarea>
                <input type='submit' value='Valider' name='AccueilSubmit'>
          </form>";
    
        include 'LinksBistrot/Section3.html';
    }
...
elseif ($page == "LinksSkatepark") {
        ...
        include 'LinksSkatepark/Section4.html';
}
...
elseif ($page == "LinksEvenement") {
        ...
        echo "<form method='post' action='txtUploadEvenement1.php' id='eventForm1'>
                <input type='text' name='titre1' id='titreAccueil1'>
                <textarea form='eventForm1' name='actualite1'></textarea>
                <input type='submit' value='Valider' name='AccueilSubmit'>
          </form>";
    
        include 'LinksEvenement/Section1.html';
    
        echo "<form method='post' action='txtUploadEvenement2.php' id='eventForm2'>
                <input type='text' name='titre2' id='titreAccueil2'>
                <textarea form='eventForm2' name='actualite2'></textarea>
                <input type='submit' value='Valider' name='AccueilSubmit'>
          </form>";
    
        include 'LinksEvenement/Section2.html';
...
elseif ($page == "LinksGroupes") {
         ...
         echo "<form method='post' action='txtUploadGroupes.php' id='eventForm1'>
                <input type='text' name='titre' id='titreAccueil1'>
                <textarea form='eventForm1' name='actualite'></textarea>
                <input type='submit' value='Valider' name='AccueilSubmit'>
          </form>";
    
        include 'LinksGroupes/Section2.html';
}
            ?>
            </div>
    </section>   
