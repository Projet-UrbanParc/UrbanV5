<?php
$target_dir = "../backEnd/LinksTrampo/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksTrampo/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksTrampo/img/header.png');
