<?php
$target_dir = "../backEnd/LinksEvenement/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksEvenement/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksEvenement/img/header.png');
