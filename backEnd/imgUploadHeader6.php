<?php
$target_dir = "../backEnd/LinksSkatepark/img/";
...
// Upload file
if(!move_uploaded_file($_FILES['file_upload']['tmp_name'], '../backEnd/LinksSkatepark/img/' . $_FILES['file_upload']['name'])){
...
rename($target_file , '../backEnd/LinksSkatepark/img/header.png');
